...
kIOMasterPortDefault = (
    0  # WAS: ctypes.c_void_p.in_dll(iokit, "kIOMasterPortDefault")
)
...
def scan_interfaces():
    ...
    for service in GetIOServicesByType("IOSerialBSDClient"):
        ...
        if device:
            ...
            if usb_device:
                name = (
                    get_string_property(usb_device, "USB Interface Name")
                    or None
                )
                locationID = (
                    get_int_property(
    ...
    for service in services:
        ...
        if device:
            ...
            if usb_device:
                ...
                info.vid = get_int_property(
                    usb_device, "idVendor", kCFNumberSInt16Type
                )
