...
class PredefinedEncodingsTests(unittest.TestCase):
    predefined_encodings = [
        ...
        [ bytes(bytearray(range(1, 254))) + b"\x00",    bytes(b"\xfe" + bytearray(range(1, 254))) + b"\x01"     ],
        [ bytes(bytearray(range(1, 255))) + b"\x00",    bytes(b"\xff" + bytearray(range(1, 255))) + b"\x01\x01" ],
        [ bytes(bytearray(range(1, 256))) + b"\x00",    bytes(b"\xff" + bytearray(range(1, 255)) + b"\x02\xff\x01") ],
    ]
