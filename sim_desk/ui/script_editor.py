...
class PythonSTC(stc.StyledTextCtrl):
    ...
    def __init__(
        ...
        self.RegisterImage(
            1, wx.ArtProvider.GetBitmap(wx.ART_NEW, size=(16, 16))
        )
        self.RegisterImage(
            2, wx.ArtProvider.GetBitmap(wx.ART_NEW, size=(16, 16))
        )
        self.RegisterImage(
    ...
    def OnKeyPressed(self, event):
        SimDeskContext().get_project_model().setDirty()
