...
class CommonProperty(TreeModel):
    def __init__(self,name,label=None, defaultvalue=wx.EmptyString,category=None,editable=True):
        ...
        if label == None: self.propertylabel = self.propertyname
...
class StringProperty(CommonProperty):
    def __init__(self,name,label=None,defaultvalue=wx.EmptyString,category=None,editable=True):
        CommonProperty.__init__(self, name,label, defaultvalue,category,editable)
        self.stringvalue = defaultvalue

    def createwxproperty(self):
        self.wxproperty = wxpg.StringProperty(self.propertylabel,self.propertyname,self.getStringValue())
        self.wxproperty.Enable(self.isEditable())
        return self.wxproperty

class FileProperty(CommonProperty):
    def __init__(self,name,label=None,defaultvalue=wx.EmptyString,category=None):
        CommonProperty.__init__(self, name,label, defaultvalue,category)
        self.stringvalue = defaultvalue
    
    def createwxproperty(self):
        self.wxproperty = wxpg.FileProperty(self.propertylabel,self.propertyname,self.getStringValue())
        return self.wxproperty
...
class BoolProperty(CommonProperty):
    ...
    def createwxproperty(self):
        self.wxproperty = wxpg.BoolProperty(self.propertylabel,self.propertyname)
    ...
    def setStringValue(self,stringvalue):
        if stringvalue == "1" or stringvalue == "true" or stringvalue == "True":
            self.stringvalue = "True"
        if stringvalue == "0" or stringvalue == "false" or stringvalue == "False":
            self.stringvalue = "False"
...
class IntProperty(CommonProperty):
    def __init__(self,name,label=None,defaultvalue=0,category=None,editable=True):
        CommonProperty.__init__(self, name,label, defaultvalue,category,editable)
        self.stringvalue = wxpg.IntProperty().ValueToString(defaultvalue)
    def createwxproperty(self):
        self.wxproperty = wxpg.IntProperty(self.propertylabel,self.propertyname)
        self.wxproperty.SetValueFromString (self.getStringValue())
        self.wxproperty.Enable(self.isEditable())
        return self.wxproperty
...
class FloatProperty(CommonProperty):
    ...
    def createwxproperty(self):
        self.wxproperty = wxpg.FloatProperty(self.propertylabel,self.propertyname)
        self.wxproperty.SetValueFromString (self.getStringValue())
        self.wxproperty.Enable(self.isEditable())
        return self.wxproperty
...
class EnumProperty(CommonProperty):
    ...
    def __init__(self,name,label=None,defaultvalue=0,category=None,enumstrs=[],enumvalues=[]):
        CommonProperty.__init__(self, name,label, defaultvalue,category)
    ...
    def createwxproperty(self):
        self.wxproperty = wxpg.EnumProperty(self.propertylabel,self.propertyname,self.enumstrs,self.enumvalues)
        self.wxproperty.SetValueFromString (self.getStringValue())
        return self.wxproperty
...
class ColourProperty(CommonProperty):
    ...
    def createwxproperty(self):
        self.wxproperty = wxpg.ColourProperty(self.propertylabel,self.propertyname)
        self.wxproperty.SetValueFromString (self.getStringValue())
        return self.wxproperty
...
class FontProperty(CommonProperty):
    def __init__(self,name,label=None,defaultvalue=wx.EmptyString,category=None):
        ...
        self.stringvalue = defaultvalue
    def createwxproperty(self):
        self.wxproperty = wxpg.FontProperty(self.propertylabel,self.propertyname)
